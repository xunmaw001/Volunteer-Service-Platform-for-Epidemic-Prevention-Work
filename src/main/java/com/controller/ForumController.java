    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                //级联表
                GongzuorenyuanEntity gongzuorenyuan = gongzuorenyuanService.selectById(forum.getGongzuorenyuanId());
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setGongzuorenyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("gongzuorenyuan_id", forum.getGongzuorenyuanId())
...
//                            forumEntity.setGongzuorenyuanId(Integer.valueOf(data.get(0)));   //工作人员 要改的
