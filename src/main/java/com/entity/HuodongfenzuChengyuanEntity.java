...
public class HuodongfenzuChengyuanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public HuodongfenzuChengyuanEntity() {

	}

	public HuodongfenzuChengyuanEntity(T t) {
		try {
    ...
    public String toString() {
        return "HuodongfenzuChengyuan{" +
            "id=" + id +
            ", huodongfenzuId=" + huodongfenzuId +
            ", yonghuId=" + yonghuId +
            ", huodongfenzuChengyuanContent=" + huodongfenzuChengyuanContent +
