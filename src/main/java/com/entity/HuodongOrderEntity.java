...
public class HuodongOrderEntity<T> implements Serializable {
    ...
    public String toString() {
        return "HuodongOrder{" +
            ...
            ", huodongId=" + huodongId +
            ", yonghuId=" + yonghuId +
            ", huodongOrderJiankangmaPhoto=" + huodongOrderJiankangmaPhoto +
            ", huodongOrderXingchengmaPhoto=" + huodongOrderXingchengmaPhoto +
            ", huodongOrderHesuanbaogaoPhoto=" + huodongOrderHesuanbaogaoPhoto +
            ", huodongOrderJieshaoText=" + huodongOrderJieshaoText +
            ", huodongOrderTypes=" + huodongOrderTypes +
