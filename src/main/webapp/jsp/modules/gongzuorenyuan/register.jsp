...
<body style="background-image:url('/fangyigongzuozhiyuanzhe/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>工作人员姓名</label>
                                    <input id="gongzuorenyuanName" name="gongzuorenyuanName" class="form-control"
                                           placeholder="工作人员姓名">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>工作人员手机号</label>
                                    <input id="gongzuorenyuanPhone" name="gongzuorenyuanPhone" class="form-control"
                                ...
                                <div class="form-group col-md-12">
                                    <label>电子邮箱</label>
                                    <input id="gongzuorenyuanEmail" name="gongzuorenyuanEmail" class="form-control"
                                           placeholder="电子邮箱">
                                </div>
                                <div class="form-group col-md-12">
    ...
    <script>
        ...
        function submit() {
            ...
            if (validform() == true && compare() == true) {
                ...
                var urlParam;
                var successMes = '';
                httpJson("gongzuorenyuan/register", "POST", data, (res) => {
                    if(res.code == 0){
