...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            else if(item.gongzuorenyuanId != null){
                shenfenCell.innerHTML = '工作人员';
            }
            ...
            if(false){}
                ...
                xingmingCell.innerHTML = item.gongzuorenyuanName;
            }
                else if(item.usersId != null){
            ...
            if(false){}
                ...
                phoneCell.innerHTML = item.gongzuorenyuanPhone;
            }
            else if(item.usersId != null){
            ...
            if(
                ...
                false
                    ...
                    || (window.sessionStorage.getItem('role') == "工作人员" && item.gongzuorenyuanId == window.sessionStorage.getItem('userId'))
