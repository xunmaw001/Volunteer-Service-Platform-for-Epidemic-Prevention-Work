            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">内部邮件登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="gongzuorenyuanName" name="gongzuorenyuanName" class="form-control"
                                                   v-model="ruleForm.gongzuorenyuanName" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="gongzuorenyuanPhone" name="gongzuorenyuanPhone" class="form-control"
                                                   v-model="ruleForm.gongzuorenyuanPhone" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>工作人员头像</label>
                                        <img id="gongzuorenyuanPhotoImg" width="100" height="100">
                                    </div>
                            <!-- 本表所有字段 -->
                                ...
                                <input id="gongzuorenyuanId" name="gongzuorenyuanId" v-model="ruleForm.gongzuorenyuanId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="neibuyoujianName" name="neibuyoujianName" class="form-control"
                                               v-model="ruleForm.neibuyoujianName" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>留言内容</label>
                                        <input style="width: 450px" id="neibuyoujianText" name="neibuyoujianText" class="form-control"
                                               v-model="ruleForm.neibuyoujianText" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "neibuyoujian/info/" + id,
