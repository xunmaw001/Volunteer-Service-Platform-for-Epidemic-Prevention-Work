    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">组工作类型管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">组工作类型列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">组工作类型列表</h3>
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" id="indexNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                               placeholder="组工作类型名称" aria-controls="tableId">
                                    </div>
                                </div>
...
<script>
    ...
    function getDataList() {
        http("dictionary/page", "GET", {
            ...
            order: sortOrder,
            //本表的
            dicCode: "huodongfenzu_types",//编码名字
            dicName: "组工作类型",//汉字名字
