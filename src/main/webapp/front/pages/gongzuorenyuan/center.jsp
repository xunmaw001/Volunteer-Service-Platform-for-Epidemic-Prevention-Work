    ...
    <ul id="category">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="gongzuorenyuanName" id="gongzuorenyuanName" lay-verify="required" placeholder="工作人员姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="gongzuorenyuanPhone" id="gongzuorenyuanPhone"  lay-verify="required|phone"   placeholder="工作人员手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="gongzuorenyuanPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="gongzuorenyuanPhoto" name="gongzuorenyuanPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="gongzuorenyuanEmail" id="gongzuorenyuanEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`gongzuorenyuan/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#gongzuorenyuanPhotoImg").attr("src", data.data.gongzuorenyuanPhoto);
                });
