            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">工作人员展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="gongzuorenyuanName" id="gongzuorenyuanName" placeholder="工作人员姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#gongzuorenyuanName').val() != null && jquery('#gongzuorenyuanName').val() != "" && jquery('#gongzuorenyuanName').val() != "null" ) {
                param['gongzuorenyuanName'] = jquery('#gongzuorenyuanName').val();
            }
                                        

            // 获取列表数据
            http.request('gongzuorenyuan/list', 'get', param, function(res) {
