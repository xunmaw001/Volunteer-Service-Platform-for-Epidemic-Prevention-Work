            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">工作人员姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="gongzuorenyuanName" id="gongzuorenyuanName"  placeholder="工作人员姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">工作人员手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="gongzuorenyuanPhone" id="gongzuorenyuanPhone"  lay-verify="phone|required"   placeholder="工作人员手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
...
<!-- 邮箱 -->
                <div class="layui-form-item" pane>
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="gongzuorenyuanEmail" id="gongzuorenyuanEmail"  lay-verify="email|required"   placeholder="电子邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
