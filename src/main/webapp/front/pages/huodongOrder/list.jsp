        ...
        <div class="right-container" style="padding-top: 0;">
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                <ul class="layui-tab-title">
                    <li class="layui-this" @click="pageList(0)">全部活动报名</li>
                    <li v-for="item in huodongOrderTypesList" :value="item.codeIndex"  @click="pageList(item.codeIndex)">{{item.indexName}}</li>
                </ul>
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <tr v-for="(item,index) in dataList" v-bind:key="index">
                            ...
                            <td style="width: 150px;">{{item.huodongOrderUuidNumber}}</td>
                            <td style="width: 250px;">
                                <img :src="item.huodongOrderJiankangmaPhoto" style="width: 100px;height: 100px;object-fit: cover;">
                            </td>
                            <td style="width: 250px;">
                                <img :src="item.huodongOrderXingchengmaPhoto" style="width: 100px;height: 100px;object-fit: cover;">
                            </td>
                            <td style="width: 250px;">
                                <img :src="item.huodongOrderHesuanbaogaoPhoto" style="width: 100px;height: 100px;object-fit: cover;">
                            </td>
                            <td style="width: 150px;">{{item.huodongOrderJieshaoText}}</td>
                            <td style="width: 80px;">{{item.huodongOrderValue}}</td>
                            <td style="width: 80px;">{{item.huodongOrderYesnoValue}}</td>
                            <td style="width: 150px;">{{item.huodongOrderYesnoText}}</td>
                            <td style="width: 150px;">{{item.huodongOrderShenheTime}}</td>
...
<script>
    ...
    // 当前表的字典表
        ...
        function huodongOrderTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=huodong_order_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function huodongOrderYesnoTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=huodong_order_yesno_types", 'get', {}, function (res) {
                if(res.code == 0){
