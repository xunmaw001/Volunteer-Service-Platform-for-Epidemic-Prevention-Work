            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">内部邮件展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="neibuyoujianName" id="neibuyoujianName" placeholder="留言标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#neibuyoujianName').val() != null && jquery('#neibuyoujianName').val() != "" && jquery('#neibuyoujianName').val() != "null" ) {
                param['neibuyoujianName'] = jquery('#neibuyoujianName').val();
            }
                                        

            // 获取列表数据
            http.request('neibuyoujian/list', 'get', param, function(res) {
