                        ...
                        <div class="portfolio-agile">
                            <div class="main">
                                <div v-for="(item,index) in dataList" v-bind:key="index" class="view view-seventh" style="width: 23%;height: 300px">
                                    <a @click="jumpCheck('../huodong/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="b-link-stripe b-animate-go thickbox">
