				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huodongAddress" id="huodongAddress" lay-verify="required" placeholder="活动地点" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huodongYiqing" id="huodongYiqing" lay-verify="required" placeholder="疫情信息" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kaishiTime" id="kaishiTime"  lay-verify="required|date"   placeholder="活动开始时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jieshuTime" id="jieshuTime"  lay-verify="required|date"   placeholder="活动结束时间" autocomplete="off" class="layui-input">
							</div>
						</div>
