            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="huodongAddress" id="huodongAddress" placeholder="活动地点" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div class="portfolio" id="gallery">
                        <div class="portfolio-agile">
                            <div class="main">
                                <div v-for="(item,index) in dataList" v-bind:key="index" class="view view-seventh" style="width: 23%;height: 300px">
                                    <i @click="deleteHuodongCollection(item.id)" class="layui-icon" style="float:right;color:red;margin-top: 0px;margin-right: 3px;font-size:20px">&#xe640;</i>
                                    <a @click="jumpCheck('../huodong/detail.jsp?id='+item.huodongId , item.huodongDelete == null?'':item.huodongDelete , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="b-link-stripe b-animate-go thickbox">
                                        <img :src="item.huodongPhoto?item.huodongPhoto.split(',')[0]:''"  style="height: 350px;width:100%;" />
                                        <div class="mask">
                                            <h4>
                                                <b>{{item.huodongName}}</b>
                                                <br>
                                                <b v-if="item.huodongNewMoney">{{item.huodongNewMoney}} RMB</b>
                                                <b v-else>{{item.huodongValue}}</b>
                                            </h4>
                                        </div>
                                    </a>
                                </div>
...
<script>
    ...
    // 级联表的字段数据
        ...
        function pageList() {
            ...
            if (jquery('#huodongAddress').val() != null && jquery('#huodongAddress').val() != "" && jquery('#huodongAddress').val() != "null" ) {
                param['huodongAddress'] = jquery('#huodongAddress').val();
            }
