    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="huodongCollectionTypes" id="huodongCollectionTypes">
                                    <option v-for="item in huodongCollectionTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`huodongCollection/session`, 'get', {}, function (data) {
                    // 表单赋值
