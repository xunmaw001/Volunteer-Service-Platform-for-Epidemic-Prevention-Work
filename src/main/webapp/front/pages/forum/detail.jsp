...
<body>
    ...
    <div id="app">
        ...
        <div v-if="detail.gongzuorenyuanId" class="auth-container">
            发布人{{detail.gongzuorenyuanName}}&nbsp;&nbsp;&nbsp;发布人权限：工作人员&nbsp;&nbsp;&nbsp;时间：{{detail.insertTime}}
        </div>
        <div v-if="detail.usersId" class="auth-container">
            ...
            <div class="message-list">
                <div class="message-item" v-for="(item,index) in dataList" v-bind:key="index">
                    ...
                    <div v-if="item.gongzuorenyuanId" class="username-container">
                        <img class="avator" :src="item.gongzuorenyuanPhoto">
                        <span class="username">工作人员：{{item.gongzuorenyuanName}}</span>
                    </div>
...
<script>
    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            ,forumYuyue(){
                let _this = this;
                // localStorage.setItem('forumId', _this.detail.id);
                // _this.jump("../forumOrder/add.jsp");

                let data={
                    forumId:_this.detail.id,
                    yonghuId:localStorage.getItem("userid"),
                    forumOrderYesnoTypes:1,
                }
                // 提交数据
                layui.http.requestJson('forumOrder/add', 'post', data, function (res) {
                    if(res.code == 0) {
                        layui.layer.msg('预约成功', {
                            time: 2000,
                            icon: 6
                        }, function () {
                            _this.jump("../forumOrder/list.jsp");
                        });
                    }else{
