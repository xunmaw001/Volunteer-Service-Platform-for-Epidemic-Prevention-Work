    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huodongfenzuName" id="huodongfenzuName" lay-verify="required" placeholder="分组名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="huodongfenzuTypes" id="huodongfenzuTypes">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`huodongfenzu/session`, 'get', {}, function (data) {
                    // 表单赋值
			   ...
			   function huodongfenzuTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=huodongfenzu_types", "GET", {}, (res) => {
					   if(res.code == 0){
