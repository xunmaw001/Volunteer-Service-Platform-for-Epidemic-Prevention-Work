            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">活动分组展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="huodongfenzuName" id="huodongfenzuName" placeholder="分组名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">组工作类型</label>
                          <div class="layui-input-inline">
                              <select name="huodongfenzuTypes" id="huodongfenzuTypes" lay-filter="huodongfenzuTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in huodongfenzuTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            huodongfenzuTypesList : [],
            huodongfenzuTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function huodongfenzuTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=huodongfenzu_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.huodongfenzuTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#huodongfenzuName').val() != null && jquery('#huodongfenzuName').val() != "" && jquery('#huodongfenzuName').val() != "null" ) {
                param['huodongfenzuName'] = jquery('#huodongfenzuName').val();
            }
         
            var huodongfenzuTypes = $("#huodongfenzuTypes").find("option:selected").val();
            if (huodongfenzuTypes != null && huodongfenzuTypes != "" && huodongfenzuTypes != "null") {
                param['huodongfenzuTypes'] = huodongfenzuTypes;
            }
                        

            // 获取列表数据
            http.request('huodongfenzu/list', 'get', param, function(res) {
