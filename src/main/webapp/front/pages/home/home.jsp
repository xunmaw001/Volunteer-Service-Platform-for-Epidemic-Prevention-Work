            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="team agileits" id="team">
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in huodongList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <div class="team-agile-img" @click="jumpCheck('../huodong/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img :src="item.huodongPhoto?item.huodongPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <div class="view-caption">
                                            <div class="w3ls-info">
                                                <h4>{{item.huodongName}}</h4>
                                            </div>
                                            <b v-if="item.huodongNewMoney" style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.huodongNewMoney}} RMB
                                            </b>
